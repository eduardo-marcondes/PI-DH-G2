        ...
        <>
            ...
            <div id="contato">
                <main>
                    <div className="titulo-bg">
                        <div className="titulo container">
                            ...
                            <h1 className="font-1-xxl cor-0">nosso contato<span className="cor-p1">.</span></h1>
                        </div>
                    </div>
                ...
                <article className="lojas container">
                    <h2 className="font-1-xxl">lojas locais<span className="cor-p1">.</span></h2>
                    <div className="lojas-item">
                        ...
                        <div className="lojas-conteudo">
                            ...
                            <p className="lojas-tempo font-1-s"><img src="./img/icones/horario.svg" alt=""/>08-18h de
                                seg à dom</p>
                        </div>
                    </div>
