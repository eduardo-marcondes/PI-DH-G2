            ...
            <main className="titulo-bg">
                <div>
                    <div className="titulo container">
                        ...
                        <h1 className="font-1-xxl cor-0">Picapes<span className="cor-p1">.</span></h1>
                    </div>
                </div>
                <div className="carro container">
                    ...
                    <div className="carro-conteudo">
                        <p className="font-2-l cor-5">Carros ideais para quem está sempre em movimento, e curte se aventurar. Possui carroceria espaçosa e tração 4x4.</p>
