            ...
            <main>
                ...
                <div className="carros">
                    ...
                    <div className="carros-conteudo">
                        ...
                        <p className="font-text-1 cor-8">Carros maiores e com um porta-malas mais amplo, para quem
                ...
                <div className="carros">
                    ...
                    <div className="carros-conteudo">
                        ...
                        <p className="font-text-1 cor-8">Carros ideais para quem está sempre em movimento, e curte se
                ...
                <div className="carros-bg">
                    <div className="carros">
                        ...
                        <div className="carros-conteudo">
                            ...
                            <p className="font-text-1 cor-1">Carros cheios de estilo, que valorizam a sua presença. Vem
