            ...
            <div className="vantagens container">
                <ul>
                    <li>
                        ...
                        <p className="font-text-1 cor-1">Sabemos que seu melhor amigo não pode ficar de fora, por isso
                    ...
                    <li>
                        ...
                        <p className="font-text-1 cor-1">Nosso atendimento é 24h. Você assina e recebe o carro sem se
                            preocupar com burocracias, a qualquer hora que desejar.</p>
                    </li>
                    <li>
                        <img src="./img/icones/sustentavel.svg" alt=""/>
                        <h3 className="font-1-l cor-0">Sustentável</h3>
                        <p className="font-text-1 cor-1">Trabalhamos com carros hibridos e automaticos, para tornar sua
                    ...
                    <li>
                        ...
                        <p className="font-text-1 cor-1">Use nosso aplicativo para localizar nossos postos parceiros e
                            ganhe desconto e vantagens.</p>
                    </li>
                    <li>
                        <img src="./img/icones/seguro.svg" alt=""/>
                        <h3 className="font-1-l cor-0">Segurança</h3>
                        <p className="font-text-1 cor-1">Com o seguro você pode viajar tranquilo, pois temos ampla rede
